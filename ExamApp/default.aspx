...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="container-fluid">
    ...
    <ul class="quick-actions">
          <li> <a href="DersYonetimi.aspx"> <i class="icon-book"></i> Ders Yönetimi </a> </li>
          <li> <a href="KonuYonetimi.aspx"> <i class="icon-pdf"></i> Konu Yönetimi</a> </li>
          <li> <a href="SoruEkleme.aspx"> <i class="icon-database"></i> Soru Yönetimi </a> </li>
          <li> <a href="SikEkleme.aspx"> <i class="icon-tag"></i> Şık Yönetimi </a> </li>
          <li> <a href="SinavOlusturma.aspx"> <i class="icon-graph"></i> Sınav Yönetimi</a> </li>
        </ul>
   </div>
    ...
    <h2>Hoşgeldiniz, <%= User.Identity.Name.ToString() %> <asp:Label ID="lblUser" runat="server" Text="" ForeColor="Red"></asp:Label>!</h2>
</asp:Content>
