<%@ Page Title="" Language="C#" MasterPageFile="~/AnaSayfa.Master" AutoEventWireup="true" CodeBehind="SinavOlusturma_old.aspx.cs" Inherits="ExamApp.SinavOlusturma" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="btnIndir" runat="server" Text="Dosyayı İndir" OnClick="btnIndir_Click" Visible="False" />
</asp:Content>
